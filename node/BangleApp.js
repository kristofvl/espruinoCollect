...
let draw = function() {
  ...
  g.setColor(0,0,0).fillRect(0,0,175,12).setColor(0,1,0);
  steps = Bangle.getStepCount();
  g.fillRect(0,0,Math.floor((steps>10000)?175:((steps*175)/10000)),10);
...
let animate = function(isIn, callback) {
  ...
  animInterval = setInterval(function() {
    ...
    if (stop) {
      ...
      if (isAnimIn) {
        // draw the date
        g.setColor(0,0,0).fillRect(0,144,175,175);
